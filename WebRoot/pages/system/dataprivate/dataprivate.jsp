  ...
  <script type="text/javascript">
      ...
      var grid = $("#maingrid").ligerGrid({
         columns: [
          ...
          url: basepath +'SystemWeb/getGrid.do?view=SYS_AUTHORITY', sortName: 'id', 
      ...
      function f_delete() {
          ...
          if (selected) {
              LG.ajax({
                  url:basepath+"sysDataPrivate/delete.do",
                  loading: '正在删除中...',
                  data: { id: selected.id },
                  success: function () {
                      LG.showSuccess('删除成功');
      ...
      grid.bind('afterSubmitEdit', function (e)
      {
          ...
          LG.ajax({
              loading: '正在保存数据中...',
              url: basepath+"sysDataPrivate/"+(isAddNew ? "insert.do" : "update.do"),
              data: data,
              success: function ()
              { 
                  grid.loadData();
