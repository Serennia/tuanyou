...
(function ($)
{
    ...
    $.ligerDefaults.Grid = {
        ...
        pageSizeOptions: [10, 20, 30, 40, 50,200,500,800,1000],  //可选择设定的每页结果数
        parms: [],                         //提交到服务器的参数
        columns: [],                          //数据源
        ...
        _initBuildPopup: function ()
        {
            ...
            if (p.allowHideColumn)
            {
                ...
                var onPopupCheckboxChange = function ()
                {
                    ...
                    //alert(parseInt($(this).attr("columnindex"))+"/"+this.checked);
                    g.toggleCol(parseInt($(this).attr("columnindex")), true, true);
                };
                if ($.fn.ligerCheckBox)
